...
// const COLORS = ["#0061f2", "#06b6d4", "#8b5cf6", "#10b981", "#f59e0b", "#ef4444", "#ec4899", "#14b8a6"];
...
//           border: "1.5px solid", width: "100%",
//           background: open ? "#fff" : "#fff",
//           borderColor: open ? "#0061f2" : "#e2e8f0",
//           boxShadow: open ? "0 0 0 3px rgba(79,70,229,.12)" : "none",
//           fontFamily: "'DM Sans',sans-serif", transition: "all .2s",
//         }}
//       >
...
//             style={{
//               display: "flex", alignItems: "center", gap: 10, padding: "9px 12px",
//               cursor: "pointer", background: !value ? "#f0f7ff" : "#fff",
//               borderBottom: "1px solid #f8fafc",
//             }}
//             onMouseEnter={e => e.currentTarget.style.background = "#f0f7ff"}
//             onMouseLeave={e => e.currentTarget.style.background = !value ? "#f0f7ff" : "#fff"}
//           >
//             <div style={{ width: 28, height: 28, borderRadius: 99, background: "#dbeafe", display: "flex", alignItems: "center", justifyContent: "center", color:"#0061f2" }}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
//             <span style={{ fontSize: 13, fontWeight: !value ? 700 : 500, color: !value ? "#0061f2" : "#0f172a" }}>All Employees</span>
//             {!value && <span style={{ marginLeft: "auto", fontSize: 11, color: "#0061f2", fontWeight: 700 }}>✓</span>}
//           </div>
...
//                   style={{
//                     display: "flex", alignItems: "center", gap: 10, padding: "9px 12px",
//                     cursor: "pointer", background: value === e.id ? "#f0f7ff" : "#fff",
//                     borderBottom: "1px solid #f8fafc",
//                   }}
//                   onMouseEnter={el => el.currentTarget.style.background = "#f0f7ff"}
//                   onMouseLeave={el => el.currentTarget.style.background = value === e.id ? "#f0f7ff" : "#fff"}
//                 >
//                   <div style={{
//                     width: 28, height: 28, borderRadius: 99, flexShrink: 0,
//                     background: e.color, color: "#fff",
...
//                   }}>{e.initials}</div>
//                   <div style={{ flex: 1 }}>
//                     <div style={{ fontSize: 13, fontWeight: value === e.id ? 700 : 500, color: value === e.id ? "#0061f2" : "#0f172a" }}>{e.name}</div>
//                     <div style={{ fontSize: 11, color: "#94a3b8" }}>{e.dept}</div>
//                   </div>
//                   {value === e.id && <span style={{ fontSize: 11, color: "#0061f2", fontWeight: 700 }}>✓</span>}
//                 </div>
//               ))
//             )}
//           </div>
...
//           transition: "border-color .2s, box-shadow .2s",
//         }}
//         onFocus={e => { e.target.style.borderColor = "#0061f2"; e.target.style.boxShadow = "0 0 0 3px rgba(79,70,229,.1)"; }}
//         onBlur={e  => { e.target.style.borderColor = "#e2e8f0"; e.target.style.boxShadow = "none"; }}
//       />
//       {value && (
//         <button onClick={() => onChange("")} style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#94a3b8", display: "flex", padding: 0 }}>
...
//               border: "none", cursor: "pointer", padding: "5px 0",
//               borderRadius: 7, fontSize: 12, fontWeight: isToday ? 700 : 400,
//               background: active ? "#0061f2" : isToday ? "#dbeafe" : "transparent",
//               color: active ? "#fff" : isToday ? "#0061f2" : "#374151",
//             }}>{day}</button>
//           );
//         })}
//       </div>
...
//       <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 20 }}>
//         {[
//           { label: "Present", value: present, svgIcon: "check",  iconBg: "#d1fae5", iconColor: "#10b981" },
//           { label: "Absent",  value: absent,  svgIcon: "x",     iconBg: "#fee2e2", iconColor: "#ef4444" },
//           { label: "Late",    value: late,    svgIcon: "clock",  iconBg: "#fef3c7", iconColor: "#f59e0b" },
//         ].map(c => (
//           <div key={c.label} style={{
//             background: "#fff", borderRadius: 14, padding: "16px 20px",
//             border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,.05)",
...
//               padding: "8px 16px", borderRadius: 99, border: "1.5px solid",
//               cursor: "pointer", fontSize: 13, fontWeight: 500,
//               background: filter === f ? "#0061f2" : "#fff",
//               color:      filter === f ? "#fff" : "#64748b",
//               borderColor:filter === f ? "#0061f2" : "#e2e8f0",
//               transition: "all .2s",
//             }}>{f}</button>
//           ))}
//         </div>
...
//       <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 20 }}>
//         {[
//           { label: "Present", value: totalPresent, svgIcon: "check",  iconBg: "#d1fae5", iconColor: "#10b981" },
//           { label: "Absent",  value: totalAbsent,  svgIcon: "x",     iconBg: "#fee2e2", iconColor: "#ef4444" },
//           { label: "Late",    value: totalLate,    svgIcon: "clock",  iconBg: "#fef3c7", iconColor: "#f59e0b" },
//         ].map(c => (
//           <div key={c.label} style={{
//             background: "#fff", borderRadius: 14, padding: "16px 20px",
//             border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0,0,0,.05)",
...
//                     <div style={{
//                       display: "inline-flex", flexDirection: "column", alignItems: "center",
//                       background: isToday ? "#0061f2" : "transparent",
//                       color: isToday ? "#fff" : "#64748b",
//                       borderRadius: 8, padding: "4px 10px",
//                     }}>
//                       <span style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: ".4px" }}>{DAY_LABELS[i]}</span>
...
//       <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 16 }}>
//         {[
//           { label: "Days Present", value: stats.present, svgIcon: "check",  iconBg: "#d1fae5", iconColor: "#10b981" },
//           { label: "Absent Days",  value: stats.absent,  svgIcon: "x",     iconBg: "#fee2e2", iconColor: "#ef4444" },
//           { label: "Late Arrivals",value: stats.late,    svgIcon: "clock",  iconBg: "#fef3c7", iconColor: "#f59e0b" },
//         ].map(c => (
//           <div key={c.label} style={{
//             background: "#fff", borderRadius: 14, padding: "14px 18px",
//             border: "1px solid #e2e8f0",
...
//                 background: day ? cellBg[status] || "#f8fafc" : "transparent",
//                 color: day ? cellColor[status] || "#94a3b8" : "transparent",
//                 outline: isToday ? `2px solid #0061f2` : "none",
//                 outlineOffset: 1,
//                 border: status === "future" ? "1px dashed #e2e8f0" : "none",
//               }}>
//                 {day && <span>{day}</span>}
...
//                 padding: "7px 22px", borderRadius: 9, border: "none", cursor: "pointer",
//                 fontSize: 13, fontWeight: 600,
//                 background: view === v ? "#0061f2" : "transparent",
//                 color:      view === v ? "#fff" : "#64748b",
//                 textTransform: "capitalize",
//               }}>{v.charAt(0).toUpperCase() + v.slice(1)}</button>
//             ))}
...
//             <button onClick={() => setDate(new Date())} style={{
//               padding: "6px 14px", borderRadius: 9,
//               border: "1.5px solid #0061f2", background: "#dbeafe",
//               color: "#0061f2", cursor: "pointer", fontSize: 12, fontWeight: 700,
//             }}>Today</button>
//           </div>
//         </div>
        ...
        {selected ? (
          ...
          <>
            <div style={{
              ...
              color: "#0061f2",
            }}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
            <span style={{ flex: 1, fontSize: 13, fontWeight: 500, color: "#94a3b8", textAlign: "left" }}>{label}</span>
          </>
        )}
        <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
...
function normalizeDateStr(dateVal) {
  ...
  // Always extract just the date portion by slicing — never parse through
  // new Date() which would apply UTC→local conversion and shift the date
  // for timezones like IST (UTC+5:30) when backend stores UTC midnight times.
  // e.g. "2026-03-19T20:30:00.000Z" → slice(0,10) → "2026-03-19" ✓
  // e.g. "2026-03-19" → slice(0,10) → "2026-03-19" ✓
  // e.g. "2026-03-19 11:01:16" → slice(0,10) → "2026-03-19" ✓
  return s.slice(0, 10);
}

function buildDayRecords(employees, attendanceData, ds) {
  const byEmp = (attendanceData || []).filter((a) => normalizeDateStr(a.date) === ds);
  const lookup = {};
  byEmp.forEach((a) => { lookup[a.employee_id] = a; });
  return (employees || []).map((e) => {
    const att = lookup[e.id];
        ...
        {[
          ...
          <div key={c.label} style={{
            ...
            <div style={{
              ...
              {c.svgIcon === "check" && <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>}
              {c.svgIcon === "x"     && <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>}
              {c.svgIcon === "clock" && <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>}
            </div>
            <div>
              <div style={{ fontSize: 28, fontWeight: 700, lineHeight: 1 }}>{c.value}</div>
              <div style={{ fontSize: 12, color: "#64748b", marginTop: 2 }}>{c.label}</div>
...
function getStatusFromAttendance(attendanceData, empId, ds) {
  const att = (attendanceData || []).find((a) => a.employee_id === empId && normalizeDateStr(a.date) === ds);
  return att ? (att.status || "present").toLowerCase() : "absent";
}
        ...
        {[
          ...
          <div key={c.label} style={{
            ...
            <div style={{
              ...
              {c.svgIcon === "check" && <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>}
              {c.svgIcon === "x"     && <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="m15 9-6 6"/><path d="m9 9 6 6"/></svg>}
              {c.svgIcon === "clock" && <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>}
            </div>
            <div>
              <div style={{ fontSize: 24, fontWeight: 700, lineHeight: 1 }}>{c.value}</div>
              <div style={{ fontSize: 11, color: "#64748b", marginTop: 2 }}>{c.label}</div>
...
export default function AttendanceContent() {
  ...
  const [date, setDate] = useState(() => {
    // Create today's date using local date parts to avoid any UTC offset issue
    const now = new Date();
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button onClick={nextPeriod} style={{ ...navBtn, width: 32, height: 32, borderRadius: 9, border: "1px solid #e2e8f0", background: "#fff" }}>›</button>
            <button onClick={() => { const n = new Date(); setDate(new Date(n.getFullYear(), n.getMonth(), n.getDate())); }} style={{
              padding: "6px 14px", borderRadius: 9,
              border: "1.5px solid #0061f2", background: "#dbeafe",
              color: "#0061f2", cursor: "pointer", fontSize: 12, fontWeight: 700,
            }}>Today</button>
